...
local PersistenceHardeningService = require(script.Parent.PersistenceHardeningService)
...
local EnvironmentPropPolishService = require(script.Parent.EnvironmentPropPolishService)
local EnvironmentFinishService = require(script.Parent.EnvironmentFinishService)
local EnvironmentFinalCleanupService = require(script.Parent.EnvironmentFinalCleanupService)
local EnvironmentClutterPolishService = require(script.Parent.EnvironmentClutterPolishService)
...
local PatternVisualService = require(script.Parent.PatternVisualService)
local TigerPatternPolishService = require(script.Parent.TigerPatternPolishService)
local EyeDetailService = require(script.Parent.EyeDetailService)
...
EnvironmentPropPolishService.Init()
EnvironmentFinishService.Init()
EnvironmentFinalCleanupService.Init()
EnvironmentClutterPolishService.Init()
LobbyService.Build()
PlayerDataService.Init(remotes)
PersistenceHardeningService.Init(PlayerDataService)
...
PatternVisualService.Init()
TigerPatternPolishService.Init()
EyeDetailService.Init()
