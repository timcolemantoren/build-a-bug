...
local CollectionController = require(clientRoot.UI.CollectionController)
...
local AudioController = require(clientRoot.AudioController)

HUDController.Init(remotes)
BugSelectController.Init(remotes)
ProfileController.Init(remotes)
CollectionController.Init(remotes)
